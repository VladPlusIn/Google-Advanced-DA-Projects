...
This project aims to predict taxi fares in New York City based on various features related to taxi trips, such as distance, time, locations, and payment type. 
The dataset used for this analysis comprises taxi trip data from 2017, including details like pickup/dropoff times, locations, fare amount, trip distance, payment type, and more.
...
Ensure you have the necessary dependencies installed (Python, Jupyter, libraries like Pandas, Matplotlib, Seaborn, Scikit-learn).
Open the Jupyter Notebook and run each cell in sequence to replicate the analysis.
Dependencies
Python 3.x
Jupyter Notebook
Pandas
...
The distribution of residuals is approximately normal, suggesting the models errors are unbiased.
Acknowledgments
